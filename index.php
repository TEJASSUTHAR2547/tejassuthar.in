  ...
  <div class="page-wrapper overflow-hidden">
        ...
        <div class="d-flex flex-column gap-4 pb-8 position-relative z-1">
          <div class="row align-items-center">
            <div class="col-xl-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
              <img src="assets/images/svgs/primary-leaf.svg" alt="" class="img-fluid animate-spin mb-2">
              <div class="d-flex align-items-end gap-3">
                <h1 class="fs-12 text-white mb-4">Creative, <span class="text-primary">SEO-Optimized</span> <br> Website
                  Design & Development</h1>
              </div>
              <div class="d-flex align-items-start gap-4">
                <p class="mb-0 text-white fs-6">Get professional <span class="text-primary">web design & development
                    services</span>
                  focused on <span class="text-primary">UI/UX</span>, <span class="text-primary">speed
                    optimization</span>,
                  <span class="text-primary">SEO</span>, <span class="text-primary">WordPress customization</span>,
                  and <span class="text-primary">digital brand growth</span> — help your business <span
                    class="text-primary">stand out</span>
                  and <span class="text-primary">attract more customers online</span>.
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-xxl-10">
                  <div class="d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="100"
                    data-aos-duration="1000">
                    <h2 class="mb-0">Ready To Transform Your Business With Professional Website Design & Development
                    </h2>
                    <p class="fs-5 mb-0">We provide custom-designed and result-driven digital solutions including
                      <strong>Website Design, Web Development, WordPress Development, E-Commerce Website, Domain &
                        Hosting Services, and Website Maintenance.</strong>
                    </p>
                    <p class="fs-5 mb-0">As one of the leading Website Design in Surat, Gujarat, India, we help
                      businesses, startups, and corporates build a high-performance online presence at an affordable
                      price. From UI/UX Planning, Wireframing, Custom Web Design, Front-End Development, WordPress
                      Customization, to Continuous Support & Maintenance – we ensure your website is fully optimized for
                      SEO, speed, responsiveness, and user experience.</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-lg-4 mb-7 mb-lg-0">
                  <div class="d-flex flex-column gap-6 pt-9 border-top" data-aos="fade-up" data-aos-delay="200"
                    ...
                    <p class="mb-0">Our aim to provide superior <strong>quality and reliability</strong> of our services
                      and get value added return on investment to our customers' business.</p>
                  </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-7 mb-lg-0">
                  <div class="d-flex flex-column gap-6 pt-9 border-top" data-aos="fade-up" data-aos-delay="300"
                    data-aos-duration="1000">
                    <h3 class="mb-0">Our Fundamentals</h3>
                    <p class="mb-0">Our Moto is <strong>“Transparency”</strong> <br> Our Goal to satisfy our customers'
                      needs <br> Reliable Services at Most Competitive Price</p>
                  </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-7 mb-lg-0">
                  <div class="d-flex flex-column gap-6 pt-9 border-top" data-aos="fade-up" data-aos-delay="400"
                    data-aos-duration="1000">
                    <h3 class="mb-0">7 X 24 SUPPORT</h3>
                    <p class="mb-0">We believe in a long term fruitful relationship, and for that we are there to
                      support <strong>7 x 24</strong> for ever project we work on!</p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-8 col-xxl-7">
              <div class="row">
                <div class="col-xxl-12">
                  <div class="d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="100"
                    data-aos-duration="1000">
                    <h2 class="mb-0 text-white">Services We Provide</h2>
                    <p class="fs-5 mb-0 text-white text-opacity-70">We specialize in designing and developing
                      responsive, SEO-friendly websites that enhance user experience and support business growth. From
                      branding and UI/UX to web development and digital optimization, our services are crafted to
              ...
              <div class="col-xl-4">
                <div class="tab-content" data-aos="zoom-in" data-aos-delay="100" data-aos-duration="1000">
                  <div class="tab-pane active" id="one" role="tabpanel" aria-labelledby="one-tab" tabindex="0">
                    <img src="assets/images/services/website-design.webp" alt="Website Design" class="img-fluid">
                  </div>
                  <div class="tab-pane" id="two" role="tabpanel" aria-labelledby="two-tab" tabindex="0">
                    <img src="assets/images/services/wordpress-development.webp" alt="WordPress Development"
                      class="img-fluid">
                  </div>
                  <div class="tab-pane" id="three" role="tabpanel" aria-labelledby="three-tab" tabindex="0">
                    <img src="assets/images/services/eCommerce-solutions.webp" alt="eCommerce Solutions Image"
                      class="img-fluid">
                  </div>
                  <div class="tab-pane" id="four" role="tabpanel" aria-labelledby="four-tab" tabindex="0">
                    <img src="assets/images/services/brand-graphics-design.webp" alt="Brand Graphics Design Image"
                      class="img-fluid">
                  </div>
                  <div class="tab-pane" id="five" role="tabpanel" aria-labelledby="five-tab" tabindex="0">
                    <img src="assets/images/services/domain-hosting.webp" alt="Domain hosting Image"
                      class="img-fluid">
                  </div>
                  <div class="tab-pane" id="six" role="tabpanel" aria-labelledby="six-tab" tabindex="0">
                    <img src="assets/images/services/website-maintenance-and-support.webp" alt="Domain hosting Image"
                      class="img-fluid">
                  </div>
                </div>
              </div>
                  ...
                  <ul class="nav nav-tabs" id="myTab" role="tablist" data-aos="fade-up" data-aos-delay="200"
                      ...
                      <div class="row w-100 gx-3">
                        <div class="col-lg-6 col-xxl-5">
                          <button class="nav-link fs-8 fw-bold py-1 px-0 border-0 rounded-0 flex-shrink-0 active"
                            ...
                            aria-controls="one" aria-selected="true">Website Design</button>
                        </div>
                        <div class="col-lg-6 col-xxl-7">
                          <p class="text-white text-opacity-70 mb-0">
                            We design clean, modern, and responsive websites that deliver an engaging user experience
                    ...
                    <li
                      ...
                      <div class="row w-100 gx-3">
                        ...
                        <div class="col-lg-6 col-xxl-7">
                          <p class="text-white text-opacity-70 mb-0">
                            We create custom WordPress websites with advanced theme customization, plugin integration,
                            and eCommerce features. Our expert developers ensure a fast, secure, and fully optimized
                            site tailored to your business.
                          </p>
                        </div>
                      </div>
                    </li>
                      ...
                      <div class="row w-100 gx-3">
                        <div class="col-lg-6 col-xxl-5">
                          <button class="nav-link fs-8 fw-bold py-1 px-0 border-0 rounded-0 flex-shrink-0"
                            ...
                            aria-controls="three" aria-selected="false">E-Commerce Solutions</button>
                        </div>
                        <div class="col-lg-6 col-xxl-7">
                          <p class="text-white text-opacity-70 mb-0">
                            We build secure and high-conversion e-commerce websites with complete customization, easy
                            product management, and seamless checkout.
                          </p>
                        </div>
                      </div>
                    </li>
                    <li
                      ...
                      <div class="row w-100 gx-3">
                        <div class="col-lg-6 col-xxl-5">
                          <button class="nav-link fs-8 fw-bold py-1 px-0 border-0 rounded-0 flex-shrink-0" id="four-tab"
                            data-bs-toggle="tab" data-bs-target="#four" type="button" role="tab" aria-controls="four"
                            aria-selected="false">Brand & Graphic Design
                          </button>
                        </div>
                        <div class="col-lg-6 col-xxl-7">
                          <p class="text-white text-opacity-70 mb-0">We craft visually compelling brand identities and
                            graphics that reflect your business values and help you stand out in the market.
                          </p>
                        </div>
                      </div>
                    </li>
                    <li
                      ...
                      <div class="row w-100 gx-3">
                        <div class="col-lg-6 col-xxl-5">
                          <button class="nav-link fs-8 fw-bold py-1 px-0 border-0 rounded-0 flex-shrink-0" id="five-tab"
                            data-bs-toggle="tab" data-bs-target="#five" type="button" role="tab" aria-controls="five"
                            aria-selected="false">Domain & Hosting Services
                          </button>
                        </div>
                        <div class="col-lg-6 col-xxl-7">
                          <p class="text-white text-opacity-70 mb-0">We provide fast, secure, and reliable domain and
                            hosting services with complete support to keep your website running smoothly.
                          </p>
                        </div>
                      </div>
                    </li>
                    <li
                      ...
                      <div class="row w-100 gx-3">
                        <div class="col-lg-6 col-xxl-5">
                          <button class="nav-link fs-8 fw-bold py-1 px-0 border-0 rounded-0 flex-shrink-0 text-start"
                            id="six-tab" data-bs-toggle="tab" data-bs-target="#six" type="button" role="tab"
                            aria-controls="six" aria-selected="false">Website Maintenance & Support
                          </button>
                        </div>
                        <div class="col-lg-6 col-xxl-7">
                          <p class="text-white text-opacity-70 mb-0">We offer ongoing website updates, performance
                            monitoring, and 24*7 support to ensure your site remains secure and fully functional.
                          </p>
                        </div>
                      </div>
                    </li>
            ...
            <div class="col-xl-8 col-xxl-7">
              <div class="row">
                <div class="col-xxl-12">
                  <div class="d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="100"
                    data-aos-duration="1000">
                    <h2 class="mb-0">Trusted Client Testimonials for <br> WordPress Development Services</h2>
                    <p class="fs-5 mb-0 text-opacity-70">Discover why businesses trust our expert WordPress development,
                      custom website design, and performance-driven web solutions. Real feedback from satisfied clients
                      who experienced measurable growth, improved user experience, and higher conversions.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row gap-7 gap-lg-0">
              ...
              <div class="card bg-primary w-100" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                <div class="card-body d-flex flex-column gap-5 gap-xl-11 justify-content-between">
                  <div class="d-flex flex-column gap-4">
                    <p class="mb-0">Client Success Insight</p>
                    <h4 class="mb-0">Working with Tejas Suthar was a great experience. He redesigned our WordPress
                      website into something modern, fast, and easy to use. We’ve noticed better performance and
                      improved visibility on Google since the launch.</h4>
                  </div>
                  <div class="hstack gap-3">
                    <img src="assets/images/testimonial/jonathan_miller.webp" alt=""
                      class="img-fluid rounded-circle overflow-hidden flex-shrink-0" width="60" height="60">
                    <div>
                      <h5 class="mb-1">Jonathan Miller</h5>
            ...
            <div class="col-lg-4 col-xl-6 d-flex align-items-stretch">
              <div class="card bg-dark w-100" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                <div class="card-body d-flex flex-column gap-5 gap-xl-11 justify-content-between">
                  <div class="d-flex flex-column gap-4">
                    <p class="mb-0 text-white text-opacity-70">eCommerce Success Review</p>
                    <h4 class="mb-0 text-white pe-xl-2">The entire development process was clear and well-organized from
                      start to finish. Tejas Suthar understood our requirements perfectly and delivered custom Elementor
                      features that fit our business needs. Our website is now faster, more stable, and bringing in
                      better-quality leads.</h4>
                    <div class="hstack gap-2">
                      <ul class="list-unstyled mb-0 hstack gap-1">
                        <li><a class="hstack" href="javascript:void(0)"><iconify-icon icon="solar:star-bold"
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="hstack gap-3">
                      <img src="assets/images/testimonial/mark_thompson.webp" alt=""
                        class="img-fluid rounded-circle overflow-hidden flex-shrink-0" width="60" height="60">
                      <div>
                        <h5 class="mb-1 text-white">Mark Thompson</h5>
                        <p class="mb-0 text-white text-opacity-70">Founder, eCommerce Retail Brand</p>
                      </div>
                    </div>
            ...
            <div class="col-lg-4 col-xl-3 d-flex align-items-stretch">
              <div class="card w-100" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                <div class="card-body d-flex flex-column gap-5 gap-xl-11 justify-content-between">
                  <div class="d-flex flex-column gap-4">
                    <p class="mb-0">Digital Growth Feedback</p>
                    <h4 class="mb-0">Tejas Suthar optimized our eCommerce website with a strong focus on speed and user
                      experience. The checkout process is now simple and smooth, and we’ve noticed improved engagement
                      along with more consistent conversions.</h4>
                  </div>
                  <div class="hstack gap-3">
                    <img src="assets/images/testimonial/emily_rodriguez.webp" alt=""
                      class="img-fluid rounded-circle overflow-hidden flex-shrink-0" width="60" height="60">
                    <div>
                      <h5 class="mb-1">Emily Rodriguez</h5>
                      <p class="mb-0">Operations Manager,<br> Digital Marketing Agency</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-8 col-xxl-7">
              <div class="row">
                <div class="col-xxl-12">
                  <div class="d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="100"
                    data-aos-duration="1000">
                    <h2 class="mb-0">Meet Our Expert WordPress & Web Development Team</h2>
                    <p class="fs-5 mb-0 text-opacity-70">Our experienced WordPress developers and web development
                      specialists build fast, secure, and SEO-optimized websites designed to improve search rankings,
                      enhance user experience, and drive measurable business growth.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-xl-3 mb-7 mb-xl-0">
              <div class="meet-team d-flex flex-column gap-4" data-aos="fade-up" data-aos-delay="100"
                ...
                <div class="meet-team-img position-relative overflow-hidden">
                  <img src="assets/images/team/tejassuthar.jpg" alt="team-img" class="img-fluid w-100">
    ...
    <section class="pricing-section py-5 py-lg-11 py-xl-12 bg-light-gray">
                ...
                <div class="row">
                  <div class="col-xxl-12">
                    <div class="d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="100"
                      ...
                      <p class="fs-5 mb-0 text-opacity-70">Get transparent and affordable pricing for professional
                        website design and development. Choose a plan based on your business goals — with no hidden
                        costs and complete customization available.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-xl-4 mb-7 mb-xl-0 d-flex align-items-stretch">
                <div class="card w-100" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                  <div class="card-body p-7 p-xxl-5 d-flex flex-column justify-content-between gap-8">
                    <div>
                      <div class="d-flex flex-column gap-6 mb-5">
                        <h5 class="mb-0 fw-medium">Starter Plan</h5>
                        <div class="hstack gap-2">
                          <h3 class="mb-0">₹10,000/-</h3>
                        </div>
                        <p class="mb-0">Best for new businesses or startups beginning their digital journey.</p>
                      </div>
                      <div class="pt-8 border-top d-flex flex-column gap-6">
                        <h6 class="mb-0 fw-bold">What’s Included:</h6>
                        <ul class="list-unstyled d-flex flex-column gap-3 mb-0">
                          <li class="hstack gap-3">
                            ...
                            <h6 class="mb-0 fw-normal">Best for new businesses or startups beginning their digital
                              journey.</h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">WordPress setup with theme customization</h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Mobile-friendly & cross-browser compatible design
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Basic On-Page SEO (Title, Meta tags, URL optimization)
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Contact form + WhatsApp or Call button integration
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Basic loading speed optimization
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Guidance on domain, hosting & SSL setup
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">7-day bug fixing support after launch
                            </h6>
                          </li>
                        </ul>
                      </div>
              ...
              <div class="col-lg-6 col-xl-4 mb-7 mb-xl-0 d-flex align-items-stretch">
                <div class="card w-100" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                  <div class="card-body p-7 p-xxl-5 d-flex flex-column justify-content-between">
                    <div>
                      <div class="d-flex flex-column gap-6 mb-5">
                        <div class="hstack gap-3">
                          <h5 class="mb-0 fw-medium">Professional Plan</h5>
                          <span class="badge text-bg-dark hstack gap-2"><iconify-icon icon="lucide:flame"
                              class="fs-5"></iconify-icon>Most Popular</span>
                        </div>
                        <div class="hstack gap-2">
                          <h3 class="mb-0 text-opacity-50 text-dark"><del>₹30,000</del></h3>
                        ...
                        <ul class="list-unstyled d-flex flex-column gap-3 mb-0">
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Everything from the Starter Plan
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Custom design for up to 10 pages
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">WooCommerce setup with basic product upload (up to 10)
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Secure payment gateway integration (Razorpay / PayPal / UPI)
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Social media & Google Map integration
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Blog setup or product showcase
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Advanced On-Page SEO (Homepage + 3 pages)
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">1-month free maintenance & technical support
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Backup setup & basic website security enablement
                            </h6>
                          </li>
                        </ul>
                      </div>
                ...
                <div class="card w-100" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                  <div class="card-body p-7 p-xxl-5 d-flex flex-column justify-content-between gap-8">
                    <div>
                      <div class="d-flex flex-column gap-6 mb-5">
                        <div class="hstack gap-3">
                          <h5 class="mb-0 fw-medium">Premium Plan</h5>
                          <span class="badge text-bg-dark hstack gap-2"><iconify-icon icon="lucide:flame"
                              class="fs-5"></iconify-icon>Fully Custom & Scalable</span>
                        </div>
                        <div class="hstack gap-2">
                          <h3 class="mb-0">₹30,000+</h3>
                        </div>
                        <p class="mb-0">Best for established businesses wanting a high-performance, fully tailored
                          website.</p>
                      </div>
                      <div class="pt-8 border-top d-flex flex-column gap-6">
                        <h6 class="mb-0 fw-bold">What’s Included:</h6>
                        <ul class="list-unstyled d-flex flex-column gap-3 mb-0">
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Everything from Professional Plan
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Custom UI/UX design & brand-first layout
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Advanced eCommerce store (unlimited products)
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Speed optimization (Core Web Vitals improvement)
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Advanced security (Firewall, malware protection, backups)
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Multi-language / multi-location setup (if needed)
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Custom features (Booking, quotation form, advanced filters, etc.)
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">3-month priority support & maintenance
                            </h6>
                          </li>
                          <li class="hstack gap-3">
                            <span
                              class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                icon="lucide:check" class="fs-6 text-dark"></iconify-icon></span>
                            <h6 class="mb-0 fw-normal">Website customization training & documentation
                            </h6>
                          </li>
                        </ul>
                      </div>
      ...
      <div class="pt-5 pt-lg-11 pt-xl-12 technology-serve-sec d-flex flex-column gap-8 aos-init aos-animate"
        data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
        <div class="container">
          <h2 class="mb-2 text-center">Technology We Serve</h2>
        </div>
        <div class="marquee w-100 d-flex align-items-center overflow-hidden">
          <div class="marquee-content technology-serve d-flex align-items-center gap-8">
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/wordpress.png" alt="wordpress" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/woocommerce.png" alt="woocommerce" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/gb.png" alt="gutenberg" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/elementor_logo.png" alt="elementor" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/divi.png" alt="divi" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/webflow.png" alt="webflow" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/Tailwind_CSS.png" alt="Tailwind_CSS" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/html5_css3.png" alt="html5_css3" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/bootstrap.png" alt="bootstrap" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/jquery.png" alt="jquery" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/javascript.png" alt="javascript" class="img-fluid">
            </div>
            <div class="marquee-tag hstack justify-content-center">
              <img src="assets/images/technology/wordpress.png" alt="wordpress" class="img-fluid">
            </div>
              ...
              <div class="row">
                <div class="col-xxl-10">
                  <div class="d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="100"
                    ...
                    <p class="fs-5 mb-0 text-opacity-70">Find quick answers to commonly asked questions about our web
                      design and development services.
                      For any additional queries or project-related assistance, feel free to contact us.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="accordion accordion-flush" id="accordionFlushExample" data-aos="fade-up" data-aos-delay="200"
                ...
                <div class="accordion-item">
                  ...
                  <div id="flush-collapseOne" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body pt-0 fs-5 text-dark">We provide website design, custom web development,
                      WordPress solutions, eCommerce website development, UI/UX design, website maintenance, and hosting
                ...
                <div class="accordion-item">
                  ...
                  <div id="flush-collapseTwo" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body pt-0 fs-5 text-dark">On average, a standard business website takes 7–15
                      working days, depending on the design complexity and features. Custom or eCommerce projects may
                      take slightly longer. We always share an estimated timeline before starting.</div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header">
                  ...
                  <div id="flush-collapseThree" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body pt-0 fs-5 text-dark">We offer both options. Most clients prefer fully
                      custom-designed websites tailored to their brand. However, if someone needs a faster and
                      budget-friendly option, we can also work using premium WordPress themes.</div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header">
                  ...
                  <div id="flush-collapseFour" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body pt-0 fs-5 text-dark">The cost depends on the type of website (business,
                      eCommerce, custom) and features required. Basic websites start from ₹15,000, while advanced
                      solutions are priced based on project scope. We provide a free quote after understanding your
                      requirements.</div>
                  </div>
                </div>
                <div class="accordion-item border-bottom">
                  ...
                  <div id="flush-collapseFive" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body pt-0 fs-5 text-dark">Yes. Every website we build is fully responsive
                      (mobile-friendly) and optimized for speed, performance, and basic on-page SEO to help improve
                      search engine ranking.</div>
                  </div>
                </div>
                <div class="accordion-item border-bottom">
                  <h2 class="accordion-header">
                  ...
                  <div id="flush-collapseSix" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body pt-0 fs-5 text-dark">Absolutely! We offer monthly maintenance, security
                      updates, content changes, performance monitoring, and 24×7 support to ensure your website always
                      runs smoothly.</div>
                  </div>
                </div>
                <div class="accordion-item border-bottom">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fs-8 fw-bold" type="button" data-bs-toggle="collapse"
                      ...
                      Can you integrate eCommerce functionality?
                    </button>
                  </h2>
                  <div id="flush-collapseSeven" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body pt-0 fs-5 text-dark">Yes, we specialize in WooCommerce and custom
                      eCommerce development. We integrate secure payment gateways, inventory management, and
                      user-friendly shopping experiences.</div>
                  </div>
                </div>
                <div class="accordion-item border-bottom">
                  <h2 class="accordion-header">
                  ...
                  <div id="flush-collapseEight" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body pt-0 fs-5 text-dark">Yes, if built on WordPress, you will receive an
                      easy-to-use admin panel. We also provide basic training so you can manage pages, images, and
                      content without technical knowledge.</div>
                  </div>
                </div>
                <div class="accordion-item border-bottom">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed fs-8 fw-bold" type="button" data-bs-toggle="collapse"
                      ...
                      Do you help with domain and hosting setup?
                    </button>
                  </h2>
                  <div id="flush-collapseNine" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body pt-0 fs-5 text-dark">Yes, we can assist in purchasing a domain and
                      hosting package, or we can provide our own hosting services depending on your preference.</div>
                  </div>
                </div>
                <div class="accordion-item border-bottom">
                  <h2 class="accordion-header">
                  ...
                  <div id="flush-collapseTen" class="accordion-collapse collapse"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body pt-0 fs-5 text-dark">Yes, we provide website redesign services to improve
                      user experience, performance, SEO, and conversion rate without changing your domain or business
                      identity.</div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-xxl-12">
                  <div class="d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="100"
                    ...
                    <p class="fs-5 mb-0 text-opacity-70">Explore expert articles on WordPress development, website
                      design, SEO optimization, eCommerce solutions, and performance improvement. Our blog shares
                      practical insights, industry trends, and proven strategies to help businesses grow online.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="d-flex flex-column gap-5 gap-xl-10">
          ...
          <div class="row justify-content-between gap-7 gap-xl-0">
            <div class="col-xl-3">
              <p class="mb-0 fs-5" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">Have a project in
                mind? Let’s discuss how we can build a fast, secure, and SEO-optimized website tailored to your business
                goals. Whether you need custom WordPress development, eCommerce solutions, or website performance
                optimization, we’re here to help.</p>
            </div>
            <div class="col-xl-8">
              <form class="d-flex flex-column gap-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                ...
                <div>
                  <input type="number" class="form-control border-bottom border-dark" id="exampleInputPhone"
                    placeholder="Phone" aria-describedby="phoneHelp">
                </div>
                <div>
